...
const MyOrder = () => {
  ...
  const filterOrders = orders
    ?.filter(
      (order) =>
        selectItem === "all" || order.orderStatus.toLowerCase() === selectItem
    )
    .filter(
      (orders) =>
        orders?.items[0].product?.productName
          .toLowerCase()
          .includes(searchTerm) ||
    ...
    <div className="container mt-16 mx-auto px-4 sm:px-8">
      <div className="py-8">
        ...
        <div className="my-2 flex sm:flex-row flex-col">
          <div className=" ml-1 flex flex-row mb-1 sm:mb-0">
                        ...
                        <tr >
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <Link to={`/orderdetails/${product?._id}`}>
                              <p
                                className="text-blue-600 whitespace-no-wrap"
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap">
                              {product?.items[0]?.product?.productPrice}(
