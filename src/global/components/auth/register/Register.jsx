    ...
    <div className=" bg-indigo-100 pt-16 w-full my-6  flex justify-center items-center">
      <div className=" bg-white w-full md:w-full sm:w-full lg:w-2/5">
        <form
          ...
          className=" w-full  p-10 rounded-lg shadow-lg min-w-full"
        >
          ...
          <div>
            ...
            />
            { error&&<p1 className="text-red-500 font-bold">{error.username}</p1>}
          </div>
          <div>
            <label
              className="text-gray-800 font-semibold block my-3 text-md"
            ...
            <input
              ...
              autoComplete="email"
            />
            { error&&<p1 className="text-red-500 font-bold">{error.email}</p1>}
          </div>
          <div>
            <label
              className="text-gray-800 font-semibold block my-3 text-md"
            ...
            <input
              ...
              autoComplete="phoneMumber"
            />
            { error&&<p1 className="text-red-500 font-bold">{error.phoneNumber}</p1>}
          </div>
          <div>
            <label
              className="text-gray-800 font-semibold block my-3 text-md"
            ...
            />
             { error&&<p1 className="text-red-500 font-bold">{error.password}</p1>}
          </div>
